...
export default function Card({
  ...
  return (
    <div className="hover__translate flex flex-col justify-between space-y-2 rounded-lg bg-lightSecondaryGray/50 p-6 shadow-md backdrop-blur-lg dark:bg-secondaryGray">
